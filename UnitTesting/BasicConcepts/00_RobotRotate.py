...
class RobotControl():
    """
    this is the constructor of the class. Here we are just initializing some of 
    the attributes we will use in our class methods.
    """
    def __init__(self):
    ...
    """
    This function is used to make sure that the first message we publish into a topic is correctly received.
    """
    ...
    """
    This function is called when we stop our program. It calls the stop_robot() method and it sets the ctrl_c attribute to True.
    """
