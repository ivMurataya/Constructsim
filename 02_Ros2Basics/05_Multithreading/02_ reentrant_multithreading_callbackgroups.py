...
"""
    ...
    Here, both callbacks will be executed regardless of whether the other one in the group is executing.
    You will need to add these modifications in Python to use a Callback Group.
    Topic subscribers, timers, service servers, and action servers. They all have an argument where you can set the callback group their callbacks will be in.
