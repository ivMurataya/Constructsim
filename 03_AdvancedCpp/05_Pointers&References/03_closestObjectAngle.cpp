...
/*Use the code of the previous exercise to add a new function to the class named "printClosestObstacleDistance". 
When this function is called, it should return the angle at which the closest obstacle is found by the laser scanner. 
Also make "const" everything in the code that can be made "const" .*/
