...
if __name__ == '__main__':
    main()
"""
You also can create the following extra script named green_test.py that with a simple slider GUI, 
you can know the best HSV range to detect green element:

cd ~/ros2_ws/
source install/setup.bash
colcon build --packages-select basics_ros2_multithreading
source install/setup.bash
ros2 run basics_ros2_multithreading green_test.py
