...
"""
    ...
    Before moving to Multithreading we need to explain the spin_once() method.
    One issue when executing the callback_function.py script was that you needed to press CTRL+C to finish it.
    ...
    It's that simple. That way, the script will not get stuck there forever.
