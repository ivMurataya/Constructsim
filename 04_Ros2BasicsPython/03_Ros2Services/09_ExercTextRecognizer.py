"""
Inside the image_callback you should detect text from the Image message, and log the text detected with the bounding box values associated with that detection.
To do so, the AI NASA division has given you the python script that has a class defined in it that you can use to do these text detections
"""
